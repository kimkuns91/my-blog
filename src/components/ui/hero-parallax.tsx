...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="relative flex h-[220vh] w-screen flex-col self-auto overflow-hidden py-40 antialiased [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="relative left-0 top-0 mx-auto w-full max-w-7xl px-4  py-20 md:py-40">
      <h1 className="text-2xl font-bold md:text-7xl dark:text-white">
        The Ultimate <br /> White Mouse{"'"}s Projects
      </h1>
